...
// Example 2 - Метод map
// Пусть функция makeCarsWithDiscount возвращает новый массив
// объектов с изменным значением свойства price в зависимости от
//  переданной скидки.
...
//     cars.filter(({ onSale }) => onSale).sort((a, b) => a - b);
